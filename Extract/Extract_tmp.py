...
def get_feature_unit(feature_name):
    ...
    unit_map = {
        ...
        'PQdis': 'euclidean', 'PonQdis': 'euclidean', 'PRdis': 'euclidean', 
        'PonRdis': 'euclidean', 'PSdis': 'euclidean', 'PonSdis': 'euclidean', 
        'PTdis': 'euclidean', 'PonTdis': 'euclidean', 'PToffdis': 'euclidean', 
        'QRdis': 'euclidean', 'QSdis': 'euclidean', 'QTdis': 'euclidean', 
        'QToffdis': 'euclidean', 'RSdis': 'euclidean', 'RTdis': 'euclidean', 
        'RToffdis': 'euclidean', 'STdis': 'euclidean', 'SToffdis': 'euclidean', 
        'PonToffdis': 'euclidean',
        ...
        'QRSarea': 'relative', 'QRSperi': 'relative',
